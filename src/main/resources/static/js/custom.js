...
/* Not necessarily needed on this weekly task but let's keep it just in case we'll need it later 
while adding a multiple sections using just single page instead of multiple pages...*/
