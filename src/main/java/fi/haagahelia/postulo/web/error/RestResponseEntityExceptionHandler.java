...
import fi.haagahelia.postulo.web.error.InvalidOldPasswordException;
import fi.haagahelia.postulo.web.error.ReCaptchaInvalidException;
import fi.haagahelia.postulo.web.error.ReCaptchaUnavailableException;
import fi.haagahelia.postulo.web.error.UserAlreadyExistException;
import fi.haagahelia.postulo.web.error.UserNotFoundException;
import fi.haagahelia.postulo.web.GenericResponse;
